...
public class CountNumberofduplicatesGroup {
    public static void main(String[] args) {

       String name = "indivisibility";

        //group3project
        //3
      //find the first duplicate r in the string above
        //declare the counter outside of loop
        //create one string to save the duplicate

        System.out.println("duplicateCounter(name) = " + duplicateCounter(name));
